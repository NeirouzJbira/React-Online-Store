...
class DepartmentsLarge extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      subDepartmentsList: this.props.getSubDepartmentsById(
        this.props.getDepartments[0]._id
      ),
      imagesList: this.props.getDepartmentImages(
        this.props.getDepartments[0]._id
      ),
    };
