...
const StyledAvatar = styled("div")`
  ...
  #icon-avatar {
    color: ${(props) =>
      props.avatarColor || lighten(0.1, props.theme.colorLightBlue)};
    font-size: 1.5rem;
    margin: 0;
    margin-right: 5px;
    padding: 0;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Badge variant="light" id="icon-avatar-text">
          {small
            ? `${value.substr(0, 1).toUpperCase()}`
            : `Hello, ${value.substr(0, 15)}!`}
        </Badge>
        <FontAwesomeIcon
          icon={open ? "caret-up" : "caret-down"}
          size="lg"
          id="icon-avatar-arrow"
        />
      </button>
      <ul className={menuClass(open, small)}>
        ...
        <li>
          <span onClick={() => handleLogout()}>
            <FontAwesomeIcon icon="sign-in-alt" className="icon-logout" />
            Logout
          </span>
        </li>
      </ul>
