...
class DepartmentsSmall extends Component {
  ...
  render() {
    const DepListComponent = (
      <DepList
        departmentsList={this.state.departmentsList}
        selectedDepartment={this.handleSelectedDepartment}
        handleClose={this.handleCloseDepartments}
      />
    );

    const subDepListComponent = (
      <SubdepList
        subDepartmentsList={this.state.subDepartmentsList}
        imagesList={this.state.imagesList}
        selectedDepartment={this.state.selectedDepartment}
        handleClose={this.handleCloseSubdepartments}
      />
    );
    ...
    return (
      <CSSTransition
        ...
        timeout={500}
        classNames="my-mobile-menu-effect"
      >
        <div id="departments-small-container">
          ...
          <button
            type="button"
            id="departments-small-close-button"
            onClick={(e) => this.handleClose()}
          >
            <FontAwesomeIcon
              className="departments-small-close-button-icon"
              icon="times"
              size="lg"
            />
          </button>
          <ul id="departments-small-list">
            <li
              className="departments-small-list-line"
              onMouseEnter={(e) => this.handleMouseEnter(1, e)}
            >
              ...
              {this.state.selectedLine === 1 ? (
                <FontAwesomeIcon
                  className="departments-small-line-icon"
                  icon="angle-right"
                  size="lg"
                />
              ) : null}
