    ...
    <div className="item-added-to-cart-container">
      <h6>
        <FontAwesomeIcon
          icon="check"
          size="sm"
          className="item-added-to-cart-icon"
        />
        Item Added to Cart!
      </h6>
      {itemImages ? (
        <img
          ...
          alt=""
          className="item-added-to-cart-image"
        />
      ) : (
        missingImage
      )}
      ...
      />
      {cartTotals.count ? (
        <p id="item-added-to-cart-cart-data">
          <span>Cart Subtotal</span> ({cartTotals.count} items): ${" "}
          {cartTotals.subtotal.$numberDecimal}
        </p>
      ) : null}
