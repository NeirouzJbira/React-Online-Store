      ...
      {cartLines.map((line) => {
        return (
          <CartLine
            key={line._id}
            lineObject={line}
            itemObject={line.item[0]}
            imageObject={cartItemImages(line.item[0]._id)[0]}
          />
        );
      })}
    </>
    ...
    container = (
      <StyledContainer>
        ...
        <StyledTable>
          ...
          <StyledTBody>{dataLines}</StyledTBody>
        </StyledTable>
            ...
            <thead>
              ...
              <tr>
                ...
                <th style={{ textAlign: "right" }}>
                  ${" "}
                  {cartTotals.subtotal
                    ? RoundDecimalNumber(cartTotals.subtotal.$numberDecimal)
                    : 0}
                </th>
              </tr>
              <tr>
                ...
                <th style={{ textAlign: "right" }}>
                  ${" "}
                  {cartTotals.tax
                    ? RoundDecimalNumber(cartTotals.tax.$numberDecimal)
                    : 0}
                </th>
              </tr>
              <tr>
                ...
                <th style={{ textAlign: "right" }}>
                  ${" "}
                  {cartTotals.total
                    ? RoundDecimalNumber(cartTotals.total.$numberDecimal)
                    : 0}
                </th>
              </tr>
            </thead>
