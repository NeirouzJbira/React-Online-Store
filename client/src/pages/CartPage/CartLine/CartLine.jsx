  ...
  return (
    <>
      <StyledRow>
        ...
        <StyledCellName>
          <StyledName>
            <Link to={itemPagePath}>{itemObject.shortName}</Link>
          </StyledName>
        </StyledCellName>
        ...
        <StyledCellAmounts>
          <StyledPrice>
            $ {RoundDecimalNumber(lineObject.price.$numberDecimal)}
          </StyledPrice>
        </StyledCellAmounts>
        <StyledCellAmounts>
          <StyledItemTotal>
            $ {RoundDecimalNumber(lineObject.itemTotal.$numberDecimal)}
          </StyledItemTotal>
        </StyledCellAmounts>
        <StyledCellTrash>
          <StyledTrashButton
            onClick={(e) => handleDeleteButton(lineObject._id)}
          >
