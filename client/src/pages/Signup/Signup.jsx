...
const handleFormSubmit = (
  ...
  const NotificationContent = (
    <>
      ...
      verify your account. Please check your email inbox for instructions on how
      to proceed.
    </>
  );

  fetchPostRegisterUser(username, password, firstName, lastName, username)
    .then((response) => {
      if (response.ok) {
                    ...
                    {({ field }) => (
                      <div className="signup-form-text-div">
                        ...
                        <input
                          ...
                          autoComplete="off"
                          type="text"
                          className="effect-border-bottom"
                          id="signup-username"
                          autoFocus
                        />
